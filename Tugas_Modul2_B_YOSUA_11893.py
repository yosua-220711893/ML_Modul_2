...
model_path = 'C:\Pembelajaran Mesin dan Pembelajaran Mendalam\MachineLearning\Tugas_B_11893'
...
if st.button("Prediksi"):
    ...
    st.write("Orang tersebut diprediksi **{outcome[rf_model_prediction[0]]}**")